...
class Contact {
    ...
    set phoneNumber(phoneNumber) {
        ...
        if (phoneNumberRegex.test(phoneNumber)) 
            this.is_phoneNumber = phoneNumber;
        else 
    ...
    toString() {
        return "First Name: " + this.firstName + " Last Name: " + this.lastName + " Add" +
                "ress: " + this.address + " City: " + this.city + " State: " + this.state + " Z" +
                "ipcode: " + this.zip + " Phone Number: " + this.phoneNumber + " Email: " +
                this.email;
    }
}

// Create an Array and push the contacts
